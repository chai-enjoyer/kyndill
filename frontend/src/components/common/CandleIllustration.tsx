...
export function CandleIllustration({ className, ariaLabel = 'A single candle' }: CandleIllustrationProps) {
  return (
    ...
    >
      ...
      <ellipse cx="100" cy="128" rx="92" ry="116" fill="url(#kyndill-candle-halo)" />
      ...
      <path d="M 84 178 C 81 184 83 192 86 196 L 86 178 Z" fill="oklch(0.90 0.015 75)" />
      <path d="M 116 184 C 119 190 117 200 114 204 L 114 184 Z" fill="oklch(0.90 0.015 75)" />
      ...
      />
      <ellipse cx="100" cy="138" rx="3" ry="6" fill="oklch(0.96 0.06 95)" />
    </svg>
  );
}
